package edu.camilacanete.ej09p04.ui.adapter
...
import edu.camilacanete.ej09p04.databinding.ItemViewHistoricalBinding
...
class ImcRecordRecyclerAdapter(
    ...
    override fun onBindViewHolder(holder: ImcRecordViewHolder, position: Int) {
        ...
        with(holder.binding){
            ...
            tvSex.text = indexRecordList.gender
        ...
        holder.binding.layoutItemHistorical.setOnLongClickListener {
